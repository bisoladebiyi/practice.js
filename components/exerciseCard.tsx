...
const ExerciseCard:React.FC<Props> = ({name,fullName, desc, className, link}) => {
  return (
    <div className={`w-full h-44 rounded-md relative overflow-hidden flex items-center cursor-pointer hover:shadow-md hover:transition-shadow shadow-purp ${className}`}>
